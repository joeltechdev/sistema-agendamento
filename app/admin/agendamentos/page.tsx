...
import AppointmentsManagementClient, { AppointmentItem } from '@/components/admin/AppointmentsManagementClient'
...
export default async function AgendamentosPage() {
  ...
  return <AppointmentsManagementClient initialAppointments={formattedAppointments} />
}
